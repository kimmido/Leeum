				...
				if( this.length ) {
					...
					return this.each(function() {
						...
						var $el 			= $(this),
							...
							$navNext		= $el.find('button.va-nav-next'),
							$navPrev		= $el.find('button.va-nav-prev');
						...
						$slices.each(function(i){
							...
							$slice.children('img').css('filter', 'grayscale(100%)');
						})
						.children('.va-title')
						...
						$slices.bind('click.vaccordion', function(e) {
							$slices.toggleClass('overlay');
							$slices.children('img').toggleClass('grayscale');
